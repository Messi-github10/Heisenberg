...
class SoftwareContext : public NonCopy {
public:
    explicit SoftwareContext(pl_gpu gpu);
    ~SoftwareContext();

    SoftwareContext(SoftwareContext&&)            = delete;
    SoftwareContext& operator=(SoftwareContext&&) = delete;
